...
#[cfg(any(target_os = "openbsd", target_os = "macos", target_os = "ios", target_os = "tvos", windows))]
...
// Will be unsafe
// when sdl_nlen > 40.
#[cfg(any(target_os = "openbsd", target_os = "freebsd", target_os = "netbsd", target_os = "macos", target_os = "ios", target_os = "tvos"))]
...
#[cfg(any(
    target_os = "freebsd",
    target_os = "netbsd",
    all(any(target_os = "macos", target_os = "ios", target_os = "tvos"), target_pointer_width = "32"),
    windows
))]
#[repr(C)]
pub struct bpf_hdr {
...
#[cfg(any(
    target_os = "openbsd",
    all(any(target_os = "macos", target_os = "ios", target_os = "tvos"), target_pointer_width = "64")
))]
#[repr(C)]
pub struct bpf_hdr {
